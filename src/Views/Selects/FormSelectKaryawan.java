 ...
 * @author su
 */
public class FormSelectKaryawan extends javax.swing.JFrame {
    private int baris;
    ...
    /**
     * Creates new form FormSelectKaryawan
     */
    public FormSelectKaryawan() {
        initComponents();
        ...
        tableKaryawan.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSelectKaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSelectKaryawan().setVisible(true);
            }
        });
    }
